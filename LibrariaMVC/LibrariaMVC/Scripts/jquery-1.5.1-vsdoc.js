...
var jQuery = function( selector, context ) {
		...
		///     &#10;2: $(html) - Krijo DOM elements on-the-fly from the provided String of raw HTML.
...
// Krijo mouseenter and mouseleave events
jQuery.each({
...
jQuery.extend({
	...
	param: function( a, traditional ) {
		///	<summary>
		///     &#10;Krijo a serialized representation of an array or object, suitable for use in a URL
...
/*
 * Krijo the request object; Microsoft failed to properly
		...
		return this[ optall.queue === false ? "each" : "queue" ](function() {
			...
			for ( p in prop ) {
				...
				if ( jQuery.isArray( prop[p] ) ) {
					// Krijo (if needed) and add to specialEasing
...
// Krijo innerHeight, innerWidth, outerHeight and outerWidth methods
