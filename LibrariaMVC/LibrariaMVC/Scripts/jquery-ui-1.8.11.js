...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_mouseStart: function(event) {
		...
		//Krijo and append the visible helper
		...
		//Libraria the helper's css position
		...
		$.each(inst.sortables, function(i) {
			...
			if(this.instance._intersectsWith(this.instance.containerCache)) {
				...
				if(!this.instance.isOver) {
					...
					this.instance.options._helper = this.instance.options.helper; //Libraria helper option to later restore it
...
$.widget("ui.droppable", {
	...
	_create: function() {
		...
		//Libraria the droppable's proportions
...
$.widget("ui.resizable", $.ui.mouse, {
	...
	_create: function() {
		...
		if(this.element[0].nodeName.match(/canvas|textarea|input|select|button|img/i)) {
			...
			//Krijo a wrapper element and set the wrapper to the new current internal element
			this.element.wrap(
...
$.effects.blind = function(o) {
	...
	return this.queue(function() {
		...
		var wrapper = $.effects.createWrapper(el).css({overflow:'hidden'}); // Krijo Wrapper
...
$.effects.bounce = function(o) {
	...
	return this.queue(function() {
		...
		// Adjust
		$.effects.save(el, props); el.show(); // Save & Show
		$.effects.createWrapper(el); // Krijo Wrapper
...
$.effects.slide = function(o) {
	...
	return this.queue(function() {
		...
		// Adjust
		$.effects.save(el, props); el.show(); // Save & Show
		$.effects.createWrapper(el).css({overflow:'hidden'}); // Krijo Wrapper
		var ref = (direction == 'up' || direction == 'down') ? 'top' : 'left';
		var motion = (direction == 'up' || direction == 'left') ? 'pos' : 'neg';
